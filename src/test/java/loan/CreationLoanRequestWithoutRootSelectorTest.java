...
@Slf4j
class CreationLoanRequestWithoutRootSelectorTest {
    ...
    @BeforeAll
    static void setup() {
        modelWithSingleAccount = LoanModelProvider.createLoanRequestModelWithoutRootSelector(singleAccountList);
        modelWithGroupAccounts = LoanModelProvider.createLoanRequestModelWithoutRootSelector(groupAccountList);
    }
